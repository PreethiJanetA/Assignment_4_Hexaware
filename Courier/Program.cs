...
namespace Courier
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                var service = new CourierServiceDb();
                        ...
                        case 2:
                            {
                                ...
                                float courierWeight = float.Parse(Console.ReadLine());
                                ...
                                CourierServiceDb courierDb = new CourierServiceDb
                                {
                                ...
                                service.InsertCourier(courierDb);
        ...
        //{
        //    string connStr = "Data Source=JANETKOOK;Initial Catalog=Ass4;Integrated Security=True;";
        //    using (SqlConnection conn = new SqlConnection(connStr))
        //    {
        //        try
        //        {
        //            conn.Open();
        //            string query = "SELECT COUNT(*) FROM usertable WHERE Username = @username AND Userpassword = @password";
